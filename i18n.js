...
const TRADUCOES = {
  pt: {
    ...
    btn_pdf_html: "📄 PDF já guardado<small>Email, WhatsApp, etc.</small>",
    btn_galeria_html: "🖼️ Foto da galeria<small>Já tirada antes</small>",
  ...
  en: {
    ...
    btn_pdf_html: "📄 Saved PDF<small>Email, WhatsApp, etc.</small>",
    btn_galeria_html: "🖼️ Photo from gallery<small>Already taken</small>",
    badge_ficheiro: "File",
