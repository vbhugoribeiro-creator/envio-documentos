...
const TRADUCOES = {
  pt: {
    ...
    btn_pdf_html: "📄 PDF já guardado<small>Recebido por email ou já no telemóvel</small>",
    btn_galeria_html: "🖼️ Foto da galeria<small>Uma foto já tirada antes</small>",
    badge_ficheiro: "Ficheiro",
  ...
  en: {
    ...
    btn_pdf_html: "📄 Saved PDF<small>Received by email or already on the phone</small>",
    btn_galeria_html: "🖼️ Photo from gallery<small>A photo already taken before</small>",
    badge_ficheiro: "File",
