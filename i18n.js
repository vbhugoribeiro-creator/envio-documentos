...
const TRADUCOES = {
  pt: {
    ...
    btn_ficheiro_html: "Já tenho o ficheiro<small>PDF ou foto já guardada no telemóvel</small>",
  ...
  en: {
    ...
    btn_ficheiro_html: "I already have the file<small>PDF or photo already saved on the phone</small>",
    badge_ficheiro: "File",
